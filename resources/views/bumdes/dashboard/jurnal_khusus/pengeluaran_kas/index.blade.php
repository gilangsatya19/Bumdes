                  ...
                  <!-- /.card -->
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Jurnal Khusus - Pengeluaran Kas</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    @if (isset($jurnals))
                                        @foreach ($jurnals as $jurnal)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/pengeluaran_kas/{{$data->id}}/edit" class="nav-icon fas fa-edit"></a>
                                                    
                                                    <form action="/pengeluaran_kas/{{$jurnal->id}}/delete" method="POST" class="d-inline">
                                                    @csrf
