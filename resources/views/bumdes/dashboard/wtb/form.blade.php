<button class="open-button" onclick="openForm()">+ Tambah Jurnal Penyesuaian</button>
<div class="form-popup" id="myForm">
    <form action="/wtb/create" method="post" class="form-container" enctype="multipart/form-data">
        @csrf
        <div class="mx-4">
            <div class="" style="margin-left: 100%">
                <button type="button" class="btn-close border-5 font-weight-bold" aria-label="Close"
            ...
            <input type="text" placeholder="Masukkan Jenis Transaksi" name="jenis_transaksi" class="form-control"
                required>
