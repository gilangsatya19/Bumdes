                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            @if ($laba_rugi_debit < $laba_rugi_kredit)
                                                <td><b>{{ formatRupiah($laba_rugi_kredit - $laba_rugi_debit) }}</b></td>
                                                <!--// laba rugi debit -->
                                                <td>-</td> <!--// laba rugi kredit -->
                                            @else
                                                <td>-</td> <!--// laba rugi debit -->
                                                <td><b>{{ formatRupiah($laba_rugi_debit - $laba_rugi_kredit) }}</b></td>
                                                <!--// laba rugi kredit -->
                                            @endif
                                            @if ($neraca_debit < $neraca_kredit)
                                                <td><b>{{ formatRupiah($neraca_kredit - $neraca_debit) }}</b></td>
                                                <!--// neraca debit -->
                                                <td>-</td> <!--// neraca kredit -->
                                            @else
                                                <td>-</td> <!--// neraca debit -->
                                                <td><b>{{ formatRupiah($neraca_debit - $neraca_kredit) }}</b></td>
                                                <!--// neraca kredit -->
                                            @endif
                                        ...
                                        <tr>
                                            ...
                                            <!--// neraca setelahnya kredit -->
                                                @if ($laba_rugi_debit < $laba_rugi_kredit)
                                                    <td><b>{{ formatRupiah($laba_rugi_debit + ($laba_rugi_kredit - $laba_rugi_debit)) }}</b>
                                                    </td> <!--// laba rugi debit -->
                                                    <td><b>{{ formatRupiah($laba_rugi_kredit) }}</b></td>
                                                    <!--// laba rugi kredit -->
                                                @else
                                                    ...
                                                    <!--// laba rugi debit -->
                                                    <td><b>{{ formatRupiah($laba_rugi_kredit + ($laba_rugi_debit - $laba_rugi_kredit)) }}</b>
                                                    </td> <!--// laba rugi kredit -->
                                                @endif
                                                @if ($neraca_debit < $neraca_kredit)
                                                    <td><b>{{ formatRupiah($neraca_debit + ($neraca_kredit - $neraca_debit)) }}</b>
                                                    </td> <!--// neraca debit -->
                                                ...
                                                @else
                                                    ...
                                                    <!--// neraca debit -->
                                                    <td><b>{{ formatRupiah($neraca_kredit + ($neraca_debit - $neraca_kredit)) }}</b>
                                                    </td> <!--// neraca kredit -->
                                                @endif
