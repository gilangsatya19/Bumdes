            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <!-- /.card -->
                        <div class="card-header px-5 rounded-3 pb-1" style="margin-top:3rem;background-color:white">
                            <div
                                class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                                <h1 class="h2">Selamat Datang, {{auth()->user()->nama}}
                                    di {{auth()->user()->company->nama}}</h1>
                            </div>
                        </div>
                        <!-- /.card -->
                        ...
                        <div class="d-flex justify-content-center border-0">
                            <div class="card mx-4 my-5 border-0" style="width: 18rem;background-color: #D9D9D9;">
                                <div class="card-body rounded-4" style="background-color: #38C976">
                                    <p class="card-text"><small class=" text-white">25/10/2022</small></p>
